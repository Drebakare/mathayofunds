                        ...
                        <div class="row text-center">
                            <div class="col-md-9 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
                                <div class="box round " style="background: #fff1e0;">
                                    <form action="{{route('submit-trade-card-form')}}" method="post"
                                                ...
                                                <div class="clearfix" id="card-form">
                                                    ...
                                                    <div class="form-field form-m-bttm" id="giftcard-country-select">
                                                        <select name="country" class="form-control"
                                                                id="giftcard-country"
                                                                aria-invalid="false" required>
                                                            <option value="" selected disabled>Select Card's Country
                                                            </option>
                                                            @foreach($countries as $country)
                                                                <option value="{{$country->id}}"
                                                                        id="usa">{{$country->name}}</option>
                                                            @endforeach
                                                    ...
                                                    <div class="form-field form-m-bttm" id="gc-denomination">
                                                        <select name="denomination" class="form-control"
                                                                ...
                                                                aria-invalid="false" required>
                                                            <option value="" selected disabled>Select Card's
                                                                Denomination
                                                            </option>
                                                            @foreach($denominations as $denomination)
                                                                <option value="{{$denomination->id}}"
                                                                        id="d-25">{{$denomination->value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-field form-m-bttm">
                                                        <select name="sell_option" class="form-control"
                                                                ...
                                                                aria-invalid="false" required>
                                                            <option value="" selected disabled>Select Card's Sell
                                                                Option
                                                            </option>
                    ...
                    if (card_type === 'card-upload') {
                        ...
                        $("select#receipt-type").change(function () {
                            ...
                            if (rt === 'cash') {
                                ...
                                html += '<input type="file" name="card_upload[]" class="custom-file-container__custom-file__custom-file-input" id="payment_proof-card-upload" accept="image/*"  required>'
                                ...
                                html += 'x</a></label><label class="custom-file-container__custom-file" style="margin-bottom: 15px;">'
                                html += '<input type="file" name="receipt_upload[]" class="custom-file-container__custom-file__custom-file-input" id="payment_proof-receipt-upload" accept="image/*" required>'
                                html += '<input type="hidden" name="MAX_FILE_SIZE" value="10485760" /><span class="custom-file-container__custom-file__custom-file-control" style="font-family: Quicksand, sans-serif;">'
