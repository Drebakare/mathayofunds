    ...
    <div class="pricing-tab  section-pad section">
        <div class="container">
            <div class="tab-custom">
                ...
                <!-- Tab panes -->
                <div class="tab-content no-pt mt-15" style="padding-right: 0px; padding-left: 0px;">
                    <div class="tab-pane fade in active no-pt no-mt" id="sell-coin-tab">
                        ...
                        <div class="row text-center">
                            <div class="col-md-3 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
                                {{--Coins QRCodes--}}
                                <div class="tab-custom" style="margin: 5px;">
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div
                                                    ...
                                                    @foreach($bitcoin_platforms as $bitcoin_platform)
                                                        ...
                                                        <span>
                                                                    <button
                                                                        onclick='copyBitcoin{{$bitcoin_platform->name}}("bitcoin{{$bitcoin_platform->name}}")'
                                                                        class="copy-button">
                                            ...
                                            <div class="row">
                                                <div
                                                    ...
                                                    @foreach($ethereum_platforms as $ethereum_platform)
                                                        ...
                                                        <img src="{{asset($ethereum_platform->qr_code)}}"
                                                             alt="box-image"
                                                             class="box-image">
                                                        <h5 class="small-wallet"
                                                            id="ethereum{{$ethereum_platform->name}}"
                                                            style="word-wrap: break-word; font-family: OpenSans; margin-left: 17px; margin-right: 17px;">
                                                            {{$ethereum_platform->wallet_address}}
                                                        </h5>
                                                        <span>
                                                                    <button
                                                                        onclick="copyEthereumBlockchain('ethereum{{$ethereum_platform->name}}')"
                                                                        class="copy-button">
                                                                        <i class="fa fa-copy"></i>&nbsp; Copy Address
                                                                    </button>
                                                                </span>
                            ...
                            <div class="col-md-6 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm"
                                ...
                                <div class="box round " style="background: #fff1e0; margin: 5px;">
                                    <form action="{{route('submit-sell-coin-form')}}" method="post"
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <div class="form-field form-m-bttm ">
                                                        <select name="platform" class="form-control"
                                                                id="bitcoin-platform"
                                                                aria-invalid="false">
                                                            <option value="" selected disabled>Select Which Platform You
                                                                Used
                                                            </option>
                                                    ...
                                                    <div class="form-field form-m-bttm">
                                                        <select name="platform" class="form-control"
                                                            ...
                                                            @foreach($ethereum_platforms as $eplatform)
                                                                <option
                                                                    value="{{$eplatform->id}}">{{$eplatform->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-field form-m-bttm">
                                                    ...
                                                    <div id="walletPayment">
                                                        <div class="form-field form-m-bttm">
                                                            <label for="wallet_balance" class="text-sm">Wallet
                                                                Balance</label>
                                                            <input name="wallet_balance"
                                                                   value="&#8358; {{number_format(Auth::user()->account_balance)}}"
                                                                   class="form-control required" aria-required="true"
                                                    ...
                                                    <div class="custom-file-container"
                                                         data-upload-id="bitcoinProofSell">
                                                        ...
                                                        >
                                                            <input type="file" name="payment-proof"
                                                                   class="custom-file-container__custom-file__custom-file-input"
                                                                   id="payment_proof-bitcoin-sell" accept="image/*"
                                                                   required>
                            ...
                            <div class="col-md-3 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm"
                                 style="padding-right: 0px; padding-left: 0px;">
                                <div class="pricing-box highlited light ucap shadow" style="margin: 5px;">
                    ...
                    <div class="tab-pane fade no-pt no-mt" id="buy-coin-tab">
                        ...
                        <div class="row text-center" style="display: flex !important; justify-content: center !important;">
                            ...
                            {{--<div class="col-md-3 col-md-offset-0 col-sm-12 col-sm-offset-2 res-m-bttm"
                                ...
                                <div class="row" style="margin: 5px;">
                                    <div class="box round shadow-alt pricing-box highlited light ucap shadow">
                                        <h4 class="ucap" style="margin-right: 5px; margin-left: 5px;">Bank Account
                                            details</h4>
                                        <hr>
                            ...
                            <div class="col-md-6 col-md-offset-0 col-sm-12 col-sm-offset-2 res-m-bttm"
                                 style="padding-right: 0px; padding-left: 0px;">
                                <div class="box round " style="background: #fff1e0; margin: 5px;">
                                    <form action="{{route('submit-buy-coin-form')}}" method="post"
                                          enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-8 col-md-offset-2">
                                                ...
                                                <div class="clearfix">
                                                    <div class="form-field form-m-bttm">
                                                        <select name="coin_type" class="form-control"
                                                            ...
                                                            @foreach($coins as $coin)
                                                                <option value="{{$coin->id}}"
                                                                        id="{{$coin->name}}-buy">{{$coin->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-field form-m-bttm">
                                                        <input id="buy-coin-amount" name="coin_amount"
                                                               placeholder="Enter USD Equivalent of Coin Amount"
                                                    ...
                                                    <div class="custom-file-container" data-upload-id="bitcoinProofBuy">
                                                        ...
                                                        >
                                                            <input type="file" name="payment_proof"
                                                                   class="custom-file-container__custom-file__custom-file-input"
                                                                   id="payment_proof-bitcoin-buy" accept="image/*"
                                                                   required>
                                                            <input type="hidden" name="MAX_FILE_SIZE" value="10485760"/>
                                                            <span
                                                                class="custom-file-container__custom-file__custom-file-control"
                                                        ...
                                                        <div
                                                            class="custom-file-container__image-preview"
                                                            id="image-preview-placeholder-bitcoin-buy"></div>
                                                    </div>
                                                    <div class="form-field form-button form-m-bttm">
                                                        <button type="submit" class="btn btn-xs btn-alt"
                                                                style="margin-top: 20px; padding-top: 10px; padding-bottom: 10px">
