                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" border="0"
                                                                   align="center" width="200" height="50">
                                                                <tr>
                                                                    <td bgcolor="#ED006F" align="center"
                                                                        style="border-radius:4px;" width="200"
                                                                        height="50">
                                                                        <div
                                            ...
                                            <tr>
                                                <td width="60%" height="70" valign="middle"
                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            <span
                                                                style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Sent to You by Mathayo Funds</span>
                                                            <br/>
                                                            <span
                                                                style="font-size:11px;color:#555;font-family:Helvetica, Arial, sans-serif;line-height:200%;">4 Salako street. Magodo-Isheri, Isheri Magodo, Kosofe, Lagos <br>+2348038103697</span>
                                                            <br/>
                                                        </div>
                                                    </div>
                                                </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" width='34'>
                                                                <div
                                                                    ...
                                                                    <div class="contentEditable">
                                                                        <a target='_blank'
                                                                           href="{{--https://twitter.com/foodxyme--}} #"
                                                                           data-default="placeholder"
                                                                           style="text-decoration:none;">
                                                                            <img src="{{asset('twitter.png')}}"
                                                                                 data-default="placeholder"
                                                                                 data-max-width='10'
                                                                                 data-customIcon="true" width='20'
                                                                                 height='20' alt='twitter'
                                                            ...
                                                            <td valign="top" width='34'>
                                                                <div
                                                                    ...
                                                                    <div class="contentEditable">
                                                                        <a target='_blank'
                                                                           href="{{--https://instagram.com/foodxymeng--}} #"
                                                                           data-default="placeholder"
                                                                           style="text-decoration:none;">
                                                                            <img src="{{asset('instagram.png')}}"
                                                                                 width="20" height="20"
                                                                                 data-max-width="10" alt='instagram'
                                                                                 style='margin-right:40px;'/>
                                                                        </a>
                                                                    </div>
                                                                </div>
