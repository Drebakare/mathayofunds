                        ...
                        <tr>
                            <td class="bg_dark email-section" style="text-align:center;">
                                <div class="heading-section heading-section-white">
                                    <span class="subheading">Welcome to MathayoFunds</span>
                                    <div width="200" valign="top" align="center">
                                    ...
                                    <p>
                                        ...
                                        address <br><br>
                                         <a href="{{Route('verify-account', ['token' => $user->token])}}" class="btn btn-primary">Verify Email</a>
                                    </p>
                                </div>
                            </td>
                        </tr><!-- end: tr -->
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                                            ...
                                            <ul>
                                                <li><span class="text">4 Salako street. Magodo-Isheri, Isheri Magodo, Kosofe, Lagos</span></li>
                                                <li><span class="text">+2348038103697</span></li>
                                            </ul>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td valign="top" width="33.333%">
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td style="text-align: left; padding-right: 10px;">
                                            <p>&copy; 2020 MathayoFunds. All Rights Reserved</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
