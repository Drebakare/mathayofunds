...
<head>
    ...
    <title>Email Support Response</title>
    <style type="text/css">
                            ...
                            <tr>
                                <td class='movableContentContainer bgItem'>
                                                ...
                                                <td width="200" valign="top" align="center">
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align='center' >
                                                            <img src="{{asset('mat_logo.png')}}"   alt='Logo'  data-default="placeholder" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td width="200" valign="top">&nbsp;</td>
                                    ...
                                    <div class='movableContent'>
                                            ...
                                            <tr>
                                                <td width="100%" colspan="3" align="center" style="padding-bottom:10px;padding-top:25px;">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='center' >
                                                            <h2 >Mathayo Funds Support Service</h2>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        --}}
                                        {{--
                                                                                                                <a target='_blank' href="{{Route('confirm-password', ['token' => $user_details->token])}}" class='link2'>Reset Password</a>
                                        --}}{{--
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" width='34'>
                                                                <div class="contentEditableContainer contentTwitterEditable" style='display:inline;'>
                                                                    <div class="contentEditable" >
                                                                        <a target='_blank' href="{{--https://twitter.com/foodxyme--}} #" data-default="placeholder"  style="text-decoration:none;">
                                                                            <img src="{{asset('twitter.png')}}" data-default="placeholder" data-max-width='10' data-customIcon="true" width='20' height='20' alt='twitter' style='margin-right:40px;'>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td valign="top" width='34'>
                                                                <div class="contentEditableContainer contentImageEditable" style='display:inline;'>
                                                                    <div class="contentEditable" >
                                                                        <a target='_blank' href="{{--https://instagram.com/foodxymeng--}} #" data-default="placeholder"  style="text-decoration:none;">
                                                                            <img src="{{asset('instagram.png')}}" width="20" height="20" data-max-width="10" alt='instagram' style='margin-right:40px;' />
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
